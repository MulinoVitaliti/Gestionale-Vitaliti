// app-recupero.js — Funzioni recuperate da app-steven.js (cancellato per errore)
// Solo funzioni non ridefinite altrove: ordini, contabilita', email, fatture, dashboard, template.
// Recupero dal commit 51d02ea. Caricato dopo app-modules.js.
...
let FOLDER_LABELS = {inbox:'In arrivo',sent:'Inviati',drafts:'Bozze',spam:'Spam'};
let templates = [];
